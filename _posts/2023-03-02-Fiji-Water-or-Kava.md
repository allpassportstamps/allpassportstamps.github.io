...
{% include image.html src="fiji/bula.jpeg" alt="bula" width="50%" loading="eager" %}
...
{% include image.html src="fiji/girl.jpeg" alt="girl" width="50%" loading="eager" %}{% include image.html src="fiji/village.jpeg" alt="village" width="50%" %}
...
{% include image.html src="fiji/lautoka.jpeg" alt="lautoka" width="50%" %}{% include image.html src="fiji/market.jpeg" alt="market" width="50%" %}
...
{% include image.html src="fiji/fish.jpeg" alt="fish" width="50%" %}{% include image.html src="fiji/fish2.jpeg" alt="fish2" width="50%" %}

The driver is of Indian descent and he showed me a bunch of the local cultural places. 

{% include image.html src="fiji/tour.jpeg" alt="tour" width="50%" %}{% include image.html src="fiji/nadi_shop.jpeg" alt="nadi_shop" width="50%" %}
...
{% include image.html src="fiji/indian.jpeg" alt="indian" width="50%" %}{% include image.html src="fiji/indian2.jpeg" alt="indian2" width="50%" %}
...
{% include image.html src="fiji/wailoaloa.jpeg" alt="wailoaloa" width="50%" %}{% include image.html src="fiji/wailoaloa2.jpeg" alt="wailoaloa2" width="50%" %}

### Exploring Nadi

{% include image.html src="fiji/nadi.jpeg" alt="nadi" width="50%" %}{% include image.html src="fiji/nadi_sign.jpeg" alt="nadi_sign" width="50%" %}
...
{% include image.html src="fiji/cultural_village.jpeg" alt="cultural_village" width="50%" %}{% include image.html src="fiji/cultural_village2.jpeg" alt="cultural_village2" width="50%" %}
...
{% include image.html src="fiji/sunshine.jpeg" alt="sunshine" width="50%" %}
...
{% include image.html src="fiji/denarau.jpeg" alt="denarau" width="50%" %}{% include image.html src="fiji/bus_denarau.jpeg" alt="bus_denarau" width="50%" %}
...
{% include image.html src="fiji/resort.jpeg" alt="resort" width="50%" %}{% include image.html src="fiji/kava.jpeg" alt="kava" width="50%" %}
...
{% include image.html src="fiji/walk.jpeg" alt="walk" width="50%" %}{% include image.html src="fiji/walk2.jpeg" alt="walk2" width="28%" %}
...
{% include image.html src="fiji/garden_giant.jpeg" alt="garden_giant" width="50%" %}{% include image.html src="fiji/country.jpeg" alt="country" width="50%" %}
