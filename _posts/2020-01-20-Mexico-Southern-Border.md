...
{% include image.html src="mexico/Melissa_firestation.JPEG" alt="Melissa" width="50%" loading="eager" %}
...
{% include image.html src="mexico/frida.JPEG" alt="Frida" width="50%" loading="eager" %}
...
{% include image.html src="mexico/school.JPEG" alt="school" width="50%" %}

I visited the Basilica de Guadalupe, and learned more about the Latin localized flavor of Catholicism. 

{% include image.html src="mexico/guadalupe.JPEG" alt="guadalupe" width="50%" %}
...
{% include image.html src="mexico/food0.JPEG" alt="food0" width="50%" %}{% include image.html src="mexico/food1.JPEG" alt="food1" width="50%" %}

{% include image.html src="mexico/food2.JPEG" alt="food2" width="50%" %}{% include image.html src="mexico/food3.JPEG" alt="food3" width="28%" %}
...
{% include image.html src="mexico/teotihuacan.JPEG" alt="teotihuacan" width="50%" %}{% include image.html src="mexico/aztec.JPEG" alt="aztec" width="50%" %}
...
{% include image.html src="mexico/lucha libre.JPEG" alt="lucha libre" width="50%" %}{% include image.html src="mexico/lucha libre2.JPEG" alt="lucha libre2" width="50%" %}
...
{% include image.html src="mexico/volcano_climb.JPEG" alt="volcano_climb" width="50%" %}{% include image.html src="mexico/volcano_toluca.JPEG" alt="volcano_toluca" width="50%" %}

## Mexico

I will definitely be back - perhaps when I am ready to hit the beaches or climb the Chichen Itza. 

{% include image.html src="mexico/CDMX monument.JPEG" alt="CDMX monument" width="28%" %}{% include image.html src="mexico/city_square.JPEG" alt="city_square" width="50%" %}
