...
{% include image.html src="cote_divoire/night.jpeg" alt="night" width="28%" loading="eager" %}

I took an easy Yango ride to my hotel in Abidjan's Plateau area (which is very similar to Manhattan, many tall buildings and on an island). Throughout the ride, I was excited to see many modern malls and cars on the road (instead of the motorbikes in Benin). Interestingly, hotels here have a government registration web form (which reminds me a lot of China).

### Day 2: Treichville and Grand Bassam

{% include image.html src="cote_divoire/pyramid.jpeg" alt="pyramid" width="28%" loading="eager" %}{% include image.html src="cote_divoire/mosque.jpeg" alt="mosque" width="50%" %}

Waking up early in the morning, I first explored the Pyramid and Salam Mosque. Because my walking tour was delayed to my last day in Cote d'Ivoire, I will cover it later in the blog. 

{% include image.html src="cote_divoire/breakfast.jpeg" alt="breakfast" width="50%" %}{% include image.html src="cote_divoire/pipi.jpeg" alt="pipi" width="28%" %}
*breakfast stand in Plateau*
...
{% include image.html src="cote_divoire/marche.jpeg" alt="marche" width="50%" %}{% include image.html src="cote_divoire/street.jpeg" alt="street" width="50%" %}

I wandered the streets of Treichville before visiting the Cap Sud mall. The mall contains many modern amenities and brands. 

{% include image.html src="cote_divoire/capsud.jpeg" alt="capsud" width="50%" %}{% include image.html src="cote_divoire/cava.jpeg" alt="cava" width="28%" %}
*Right: masks made from cow bones*
...
{% include image.html src="cote_divoire/beach.jpeg" alt="beach" width="50%" %}{% include image.html src="cote_divoire/tree.jpeg" alt="tree" width="28%" %}
*The ocean is beautiful and many people were in the water, with horse rides being sold too.*
...
{% include image.html src="cote_divoire/spag.jpeg" alt="spag" width="28%" %}{% include image.html src="cote_divoire/cityhall.jpeg" alt="cityhall" width="50%" %}

My guide Merceline and I had been communicating on WhatsApp and unfortunately she ran pretty late. 
...
{% include image.html src="cote_divoire/map.jpeg" alt="map" width="50%" %}{% include image.html src="cote_divoire/hospital.jpeg" alt="hospital" width="50%" %}

The buildings in Bassam were mostly built when GB was the capital. Since abandonment, many buildings are abandoned, but some were maintained. 
...
{% include image.html src="cote_divoire/gov1.jpeg" alt="gov1" width="50%" %}{% include image.html src="cote_divoire/gov2.jpeg" alt="gov2" width="28%" %}

We walked through the governors' office that is now the costume museum featuring the Akan (Ghanaian tribes) and other tribes like Dan that were here. 

{% include image.html src="cote_divoire/gb1.jpeg" alt="gb1" width="50%" %}{% include image.html src="cote_divoire/gb2.jpeg" alt="gb2" width="28%" %}
*Right: These cones are very popular here in Cote d'Ivoire instead of cylindrical structures or posts?*

We walked through the first hotels and a restaurant that everyone loves called La Case Bleue.

{% include image.html src="cote_divoire/gb3.jpeg" alt="gb3" width="50%" %}{% include image.html src="cote_divoire/gb4.jpeg" alt="gb4" width="50%" %}
...
{% include image.html src="cote_divoire/gb5.jpeg" alt="gb5" width="28%" %}{% include image.html src="cote_divoire/gb6.jpeg" alt="gb6" width="50%" %}
...
{% include image.html src="cote_divoire/gb7.jpeg" alt="gb7" width="50%" %}{% include image.html src="cote_divoire/gb8.jpeg" alt="gb8" width="50%" %}

We went to the beach to watch the sunset with the fishing boats and village in the backdrop.  Merceline heard that I wanted to try garba (attieke, fish, spices) and we went to a restaurant together.

{% include image.html src="cote_divoire/gb9.jpeg" alt="gb9" width="50%" %}{% include image.html src="cote_divoire/gb10.jpeg" alt="gb10" width="50%" %}
*Left: The King's palace of the Akan people built in 2003. There is a distinctive king's stone.*
...
{% include image.html src="cote_divoire/yango1.jpeg" alt="yango1" width="18%" %}{% include image.html src="cote_divoire/yango2.jpeg" alt="yango2" width="50%" %}

Finally, after a whole hour, a miracle driver accepted and get me back to Abidjan. Phew!!! I need to get myself home before dark with more buffer room in the future. 
...
{% include image.html src="cote_divoire/roadtrip.jpeg" alt="roadtrip" width="28%" %}
...
{% include image.html src="cote_divoire/foundation.jpeg" alt="foundation" width="50%" %}{% include image.html src="cote_divoire/senate.jpeg" alt="senate" width="50%" %}
...
{% include image.html src="cote_divoire/village.jpeg" alt="village" width="28%" %}{% include image.html src="cote_divoire/rda.jpeg" alt="rda" width="28%" %}
...
{% include image.html src="cote_divoire/basilica1.jpeg" alt="basilica1" width="50%" %}{% include image.html src="cote_divoire/basilica2.jpeg" alt="basilica2" width="50%" %}
...
{% include image.html src="cote_divoire/basilica3.jpeg" alt="basilica3" width="50%" %}{% include image.html src="cote_divoire/basilica4.jpeg" alt="basilica4" width="50%" %}
...
{% include image.html src="cote_divoire/basilica5.jpeg" alt="basilica5" width="50%" %}{% include image.html src="cote_divoire/basilica6.jpeg" alt="basilica6" width="28%" %}
...
{% include image.html src="cote_divoire/basilica7.jpeg" alt="basilica7" width="50%" %}{% include image.html src="cote_divoire/crocodile.jpeg" alt="crocodile" width="50%" %}
...
{% include image.html src="cote_divoire/bushmeat.jpeg" alt="bushmeat" width="50%" %}{% include image.html src="cote_divoire/hotel_parlimentary.jpeg" alt="hotel_parlimentary" width="50%" %}
...
{% include image.html src="cote_divoire/bfh.jpeg" alt="fhb" width="50%" %}
...
{% include image.html src="cote_divoire/stpaul.jpeg" alt="stpaul" width="50%" %}{% include image.html src="cote_divoire/view.jpeg" alt="view" width="28%" %}
...
{% include image.html src="cote_divoire/news.jpeg" alt="news" width="28%" %}{% include image.html src="cote_divoire/baguette.jpeg" alt="baguette" width="28%" %}
