...
{% include image.html src="new_zealand/auckland.jpeg" alt="auckland" width="50%" loading="eager" %}{% include image.html src="new_zealand/auck2.jpeg" alt="auck2" width="50%" loading="eager" %}
...
{% include image.html src="new_zealand/Ponsonby.jpeg" alt="Ponsonby" width="50%" %}{% include image.html src="new_zealand/Ponsonby2.jpeg" alt="Ponsonby2" width="50%" %}
...
{% include image.html src="new_zealand/auckland2.jpeg" alt="auckland2" width="50%" %}
...
{% include image.html src="new_zealand/hobbiton.jpeg" alt="hobbiton" width="50%" %}{% include image.html src="new_zealand/hobbiton2.jpeg" alt="hobbiton2" width="50%" %}

{% include image.html src="new_zealand/hobbiton3.jpeg" alt="hobbiton3" width="50%" %}
...
{% include image.html src="new_zealand/Waiotapu.jpeg" alt="Waiotapu" width="50%" %}{% include image.html src="new_zealand/Waiotapu2.jpeg" alt="Waiotapu2" width="50%" %}

{% include image.html src="new_zealand/Waiotapu3.jpeg" alt="Waiotapu3" width="50%" %}
...
{% include image.html src="new_zealand/maori.jpeg" alt="maori" width="50%" %}{% include image.html src="new_zealand/maori2.jpeg" alt="maori2" width="50%" %}

{% include image.html src="new_zealand/maori3.jpeg" alt="maori3" width="50%" %}
...
{% include image.html src="new_zealand/pie.jpeg" alt="pie" width="50%" %}{% include image.html src="new_zealand/jianbing.jpeg" alt="jianbing" width="28%" %}
...
{% include image.html src="new_zealand/mcdonalds.jpeg" alt="mcdonalds" width="28%" %}
...
{% include image.html src="new_zealand/kiwi.jpeg" alt="kiwi" width="50%" %}{% include image.html src="new_zealand/kiwi2.jpeg" alt="kiwi2" width="28%" %}
